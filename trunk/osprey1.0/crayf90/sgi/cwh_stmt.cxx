  ...
  if (cwh_stk_get_class() == STR_item) {
   ...
   ffmm = cwh_stk_get_class(); //test Sept
    ...
    case WN_item_whole_array:
      ...
      cwh_addr_pstore_WN(wn,0,ts,rhs);
      break  ;
    ...
    case FLD_item:
      ...
      if (cwh_stk_get_class() == ST_item ||
        ...
        st  = cwh_stk_pop_ST();
        cwh_addr_pstore_ST(st,det.off,det.type,rhs);
        ...
        wn = F90_Wrap_ARREXP(wn);
        cwh_addr_pstore_WN(wn,0,det.type,rhs);
      }
      break;
