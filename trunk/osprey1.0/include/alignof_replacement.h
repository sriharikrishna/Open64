/* $Id: alignof_replacement.h,v 1.1 2003-12-09 19:10:25 eraxxon Exp $ */
/* -*-Mode: C;-*- */
 ...
 * ----------------------------------------------------------------
 *
 * See: http://m17n.org/martin/writings/alignof.html
 *
 ****************************************************************************/
 ...
 *  - Converted initial comments into classic C comments (for non C99
 *    compilers).
 *
 * Description: 
 *
 * This file provides a relatively portable C and C++ workaround for
 * the common compiler builtin alignof().  Note that because the C and
 * C++ versions are implemented quite differently, be careful about
 * assuming they will produce identical results.
 * 
 *   ALIGNOF (type)
...
#ifndef ALIGNOF_REPLACEMENT_HPP_INCLUDED_
#define ALIGNOF_REPLACEMENT_HPP_INCLUDED_
