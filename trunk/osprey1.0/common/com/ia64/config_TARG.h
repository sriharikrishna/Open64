...
#ifdef _KEEP_RCS_ID
/*REFERENCED*/
static char *config_TARG_h_rcs_id = "$Source: /m_home/m_utkej/Argonne/cvs2svn/cvs/Open64/osprey1.0/common/com/ia64/config_TARG.h,v $ $Revision: 1.6 $";
#endif /* _KEEP_RCS_ID */
