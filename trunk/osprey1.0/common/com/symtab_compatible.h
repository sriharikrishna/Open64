...
inline BOOL
TY_AR_empty_lbnd (const TY& ty, INT32 i)
{
    return ARB_empty_lbnd (TY_arb(ty)[i]);
}

inline void
Set_TY_AR_empty_lbnd (const TY& ty, INT32 i)
{
    Set_ARB_empty_lbnd (TY_arb(ty)[i]);
}

inline void
Clear_TY_AR_empty_lbnd (const TY& ty, INT32 i)
{
    Clear_ARB_const_lbnd (TY_arb(ty)[i]);
}

inline BOOL
TY_AR_empty_ubnd (const TY& ty, INT32 i)
{
    return ARB_empty_ubnd(TY_arb(ty)[i]);
}

inline void
Set_TY_AR_empty_ubnd (const TY& ty, INT32 i)
{
    Set_ARB_empty_ubnd (TY_arb(ty)[i]);
}

inline void
Clear_TY_AR_empty_ubnd (const TY& ty, INT32 i)
{
    Clear_ARB_empty_ubnd (TY_arb(ty)[i]);
}

inline BOOL
TY_AR_star_ubnd (const TY& ty, INT32 i)
{
    return ARB_star_ubnd(TY_arb(ty)[i]);
}

inline void
Set_TY_AR_star_ubnd (const TY& ty, INT32 i)
{
    Set_ARB_star_ubnd (TY_arb(ty)[i]);
}

inline void
Clear_TY_AR_star_ubnd (const TY& ty, INT32 i)
{
    Clear_ARB_star_ubnd (TY_arb(ty)[i]);
}
inline BOOL
TY_AR_empty_stride (const TY& ty, INT32 i)
{
    return ARB_empty_stride(TY_arb(ty)[i]);
}

inline void
Set_TY_AR_empty_stride (const TY& ty, INT32 i)
{
    Set_ARB_empty_stride (TY_arb(ty)[i]);
}

inline void
Clear_TY_AR_empty_stride (const TY& ty, INT32 i)
{
    Clear_ARB_empty_stride (TY_arb(ty)[i]);
}
