...
// Solaris workaround
// Solaris CC and g++ are lack of definition of trunc() ?
// The new gcc-3.0 has it.
#if defined(_SOLARIS_SOLARIS) || (defined(_LINUX_LINUX) && (__GNUC__ < 3))
//
// Provide trunc(), which doesn't exist in the GNU library. 
// should be handled by other way.
//
...
// Solaris CC error
// the CC compiler generates error msg:  Cannot cast from long double
// to QUAD_TYPE. QUAD_TYPE is defined as struct { INT32 qval[4]; } in
// common/com/targ_const.h. Solved by changing defs.h and define
// QUAD_TYPE as long double.
