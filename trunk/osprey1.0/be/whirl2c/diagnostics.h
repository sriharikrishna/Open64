...
typedef enum Diag_Code
{
   ...
   /* purple diagnostics */
   DIAG_PRP_FIRST = 500,
   DIAG_PRP_OPTION_ILLEGAL = 501,
   DIAG_PRP_OPTION_MISSING_SRC = 502,
   DIAG_PRP_NAME_OVERFLOW = 503,
   DIAG_PRP_FILE_ERROR = 510,
   DIAG_PRP_FILE_CANNOT_OPEN = 511,
   DIAG_PRP_FILE_CANNOT_CLOSE = 512,
   DIAG_PRP_FILE_OVERWRITTEN = 513,
   DIAG_PRP_FILE_AT_END = 514,
   DIAG_PRP_FILE_NOT_OPEN = 515,
   DIAG_PRP_FILE_NOT_CLOSED = 516,
   DIAG_PRP_FILE_HEADER_ERROR = 517,
   DIAG_PRP_ITEM_INPUT_ERROR = 519,
   DIAG_PRP_EXPECTED_PURPLE_REGION = 520,
   DIAG_PRP_PREREQUISITE_CALL = 521,
   DIAG_PRP_EXPECTED_CONSTRAINT = 522,
   DIAG_PRP_UNEXPECTED_OPCODE = 523,
   DIAG_PRP_UNEXPECTED_TYPE= 524,
   DIAG_PRP_INVALID_LEXEME_KIND = 525,
   DIAG_PRP_INVALID_TRACE_ITEM_KIND = 526,
   DIAG_PRP_CANNOT_ASSIGN_OBJECT = 527,
   DIAG_PRP_ILLEGAL_SET = 528,
   DIAG_PRP_RVALUE_ERROR = 529,
   DIAG_PRP_PLACEHOLDER_ERROR = 530,
   DIAG_PRP_PREG_VALUE = 531,
   DIAG_PRP_MEM_VALUE = 532,
   DIAG_PRP_VALUE_SPACE = 533,
   DIAG_PRP_VARIABLE_DEF = 534,
   DIAG_PRP_DEFINED_MEM_SPACE = 535,
   DIAG_PRP_PU_MMAP = 536,
   DIAG_PRP_FILE_MMAP = 537,
   DIAG_PRP_PROGRAM_MMAP = 538,
   DIAG_PRP_ICALL = 539,
   DIAG_PRP_REF_PARAM = 540,
   DIAG_PRP_CANNOT_HANDLE_CONSTRUCT= 541,
   DIAG_PRP_EDIT_OUTPUT= 542,
   DIAG_PRP_LAST = 542,
