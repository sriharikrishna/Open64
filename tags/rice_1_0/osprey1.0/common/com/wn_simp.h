...
/*---------------------------------------------------------------------------
 ...
 Description:
  ...
  WN *WN_SimplifyPstore(OPCODE opc, WN_OFFSET offset, TY_IDX ty, UINT field_id, WN *
value, WN *addr);
...
extern WN *WN_SimplifyPstore(OPCODE opc, WN_OFFSET offset, 
                            TY_IDX ty, UINT field_id, WN *value, WN *addr);
