...
// $Author: dsystem $
// $Source: /m_home/m_utkej/Argonne/cvs2svn/cvs/Open64/osprey1.0/be/opt/opt_region_emit.h,v $
//
// Revision history:
...
#ifdef _KEEP_RCS_ID
static char *opt_region_emitrcs_id = 	opt_region_emit_INCLUDED"$Revision: 1.1.1.1 $";
#endif /* _KEEP_RCS_ID */
