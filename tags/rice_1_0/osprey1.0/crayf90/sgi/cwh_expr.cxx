...
#ifdef _KEEP_RCS_ID
static char *rcs_id = "$Source: /m_home/m_utkej/Argonne/cvs2svn/cvs/Open64/osprey1.0/crayf90/sgi/cwh_expr.cxx,v $ $Revision: 1.1.1.1 $";
#endif /* _KEEP_RCS_ID */
 ...
 * fei_implicit_expr
 *
 * push a OPR_IMPLICIT_BND WN onto the stack.
 *
 *=============================================
 */
extern void
fei_implicit_expr (void)

{
   OPCODE opc;
//   WN *null_wn = NULL;
   WN * wn ;
   opc = OPCODE_make_op(OPR_IMPLICIT_BND,MTYPE_V,MTYPE_V);
   wn = WN_Create(opc,0);

// March  cwh_stk_push(null_wn,WN_item);
  cwh_stk_push(wn,WN_item);
}
