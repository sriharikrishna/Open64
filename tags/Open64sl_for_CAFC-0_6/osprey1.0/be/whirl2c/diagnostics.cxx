...
void Diag_Init(void)
{
   ...
   Diag_Msg[DIAG_PRP_OPTION_ILLEGAL] = 
      "Illegal %s option: %s\n";
   Diag_Msg[DIAG_PRP_OPTION_MISSING_SRC] = 
      "Missing source file for PURPLE processing";
   Diag_Msg[DIAG_PRP_NAME_OVERFLOW] = 
      "The input overflows a name-buffer: %s\n";
   Diag_Msg[DIAG_PRP_FILE_ERROR] = "Error in accessing file: %s\n";
   Diag_Msg[DIAG_PRP_FILE_CANNOT_OPEN] = "Cannot open file: %s\n";
   Diag_Msg[DIAG_PRP_FILE_CANNOT_CLOSE] = "Cannot close file: %s\n";
   Diag_Msg[DIAG_PRP_FILE_OVERWRITTEN] = "Overwrites existing file: %s\n";
   Diag_Msg[DIAG_PRP_FILE_AT_END] = "Attempt to go beyond end of file: %s\n";
   Diag_Msg[DIAG_PRP_FILE_NOT_OPEN] = "Attemp at accessing unopened file\n";
   Diag_Msg[DIAG_PRP_FILE_NOT_CLOSED] = "Forgot to close file: %s\n";
   Diag_Msg[DIAG_PRP_FILE_HEADER_ERROR] = "Error in header of file: %s\n";
   Diag_Msg[DIAG_PRP_ITEM_INPUT_ERROR] = 
      "Unexpected item found in purple input-file (%s):\n"
      "-- ignoring remaining input";
   Diag_Msg[DIAG_PRP_EXPECTED_PURPLE_REGION] = 
      "Missing PURPLE region definition";
   Diag_Msg[DIAG_PRP_PREREQUISITE_CALL] = 
      "Need to call %s(), before %s()";
   Diag_Msg[DIAG_PRP_EXPECTED_CONSTRAINT] = 
      "Missing PURPLE region constraint %s";
   Diag_Msg[DIAG_PRP_UNEXPECTED_OPCODE] = 
      "unexpected opcode (%d) in PURPLE routine %s()";
   Diag_Msg[DIAG_PRP_UNEXPECTED_TYPE] = 
      "unexpected type (%s) in PURPLE routine %s()";
   Diag_Msg[DIAG_PRP_INVALID_LEXEME_KIND] = 
      "invalid lexeme-kind (%d) in PURPLE routine %s()";
   Diag_Msg[DIAG_PRP_INVALID_TRACE_ITEM_KIND] = 
      "invalid trace item kind (%d) in PURPLE routine %s()";
   Diag_Msg[DIAG_PRP_CANNOT_ASSIGN_OBJECT] = 
      "illegal use of %s; assignment not supported";
   Diag_Msg[DIAG_PRP_ILLEGAL_SET] = 
      "illegal set in %s()";
   Diag_Msg[DIAG_PRP_RVALUE_ERROR] = 
      "illegal access to rvalue attribute";
   Diag_Msg[DIAG_PRP_PLACEHOLDER_ERROR] = 
      "Encountered unexpected purple placeholder format in %s";
   Diag_Msg[DIAG_PRP_PREG_VALUE] = 
      "Error in preg value mapping; %s";
   Diag_Msg[DIAG_PRP_MEM_VALUE] = 
      "Error in memory value mapping; %s";
   Diag_Msg[DIAG_PRP_VALUE_SPACE] = 
      "Error in memory value space; %s";
   Diag_Msg[DIAG_PRP_VARIABLE_DEF] = 
      "Error in variable definition; %s";
   Diag_Msg[DIAG_PRP_DEFINED_MEM_SPACE] = 
      "Error in defined memory space; %s";
   Diag_Msg[DIAG_PRP_PU_MMAP] = 
      "Error in PU memory mapping; %s";
   Diag_Msg[DIAG_PRP_FILE_MMAP] = 
      "Error in file memory mapping; %s";
   Diag_Msg[DIAG_PRP_PROGRAM_MMAP] = 
      "Error in program memory mapping; %s";
   Diag_Msg[DIAG_PRP_ICALL] = 
      "Cannot handle indirect call; %s";
   Diag_Msg[DIAG_PRP_REF_PARAM] = 
      "Purple cannot trace reference parameter (%d) value; %s";
   Diag_Msg[DIAG_PRP_CANNOT_HANDLE_CONSTRUCT] = 
      "Purple cannot handle construct: %s";
   Diag_Msg[DIAG_PRP_EDIT_OUTPUT] = 
      "You need to edit the output file: %s";
