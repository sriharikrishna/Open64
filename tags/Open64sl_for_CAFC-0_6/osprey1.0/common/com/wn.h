...
***             UINT field_id
***     )
***             Return a PSTORE (with offset) of type desc.
***             Alignment must be specified
***
***
***	
...
extern WN *WN_CreateIstore(OPERATOR opr,
			  ...
			  WN *addr,
			  UINT field_id = 0);
extern WN *WN_CreatePstore(OPERATOR opr,
                          TYPE_ID rtype,
                          TYPE_ID desc,
                          WN_OFFSET offset,
                          TY_IDX ty,
...
inline WN *
WN_CreatePstore (OPCODE opc, WN_OFFSET offset, TY_IDX ty, WN *value, WN *addr,
                 UINT field_id = 0) {
  return WN_CreatePstore (OPCODE_operator(opc), OPCODE_rtype(opc),
                          OPCODE_desc(opc), offset, ty, value, addr, field_id);
}
...
extern WN *WN_CreateStid(OPERATOR opr,
			 ...
			 WN *value,
			 UINT field_id = 0);
extern WN *WN_CreatePStid(OPERATOR opr,
                         TYPE_ID rtype,
                         TYPE_ID desc,
                         WN_OFFSET offset,
                         ST *st,
...
inline WN *
     WN_CreateStid(OPCODE opc, WN_OFFSET offset, ST *st, TY_IDX ty, 
                                          WN *value, UINT field_id = 0) {
  return WN_CreateStid (OPCODE_operator(opc), OPCODE_rtype(opc),
			OPCODE_desc(opc), offset, st, ty, value, field_id);
}
inline WN *
WN_CreatePStid(OPCODE opc, WN_OFFSET offset, ST *st, TY_IDX ty,
                                             WN *value, UINT field_id = 0) {
  return WN_CreatePStid (OPCODE_operator(opc), OPCODE_rtype(opc),
                        OPCODE_desc(opc), offset, st, ty, value, field_id);
}
...
extern WN *WN_Istore(TYPE_ID desc,
		     ...
		     WN *value,
		     UINT field_id = 0);
extern WN *WN_Pstore(TYPE_ID desc,
                     WN_OFFSET offset,
                     TY_IDX align,
                     WN *addr,
                     WN *value,
...
extern WN *WN_PStid(TYPE_ID desc,
                   WN_OFFSET offset,
                   ST *sym,
                   TY_IDX align,
                   WN *value,
...
WN_CreatePStid (OPERATOR opr, TYPE_ID rtype, TYPE_ID desc,
               ...
               UINT field_id = 0)
{
 return WN_CreatePStid (opr, rtype, desc, offset, &St_Table[st], ty, value, 
                                          field_id);
}
...
inline WN *
WN_CreatePStid (OPCODE opc, WN_OFFSET offset, ST_IDX st, TY_IDX ty, WN *value,
               UINT field_id = 0)
{
    return WN_CreatePStid (OPCODE_operator(opc), OPCODE_rtype(opc),
                          OPCODE_desc(opc), offset, st, ty, value, field_id);
