 ...
 * ====================================================================
 *
 * $Source: /m_home/m_utkej/Argonne/cvs2svn/cvs/Open64/osprey1.0/common/com/config_purple.cxx,v $
 *
 * Revision history:
...
{ { OVK_BOOL,	OV_SHY,	FALSE, "",             NULL,
       0, 0, 0, &PRF.enabled,             NULL,
       "Enable region instrumentation and code-extraction" },
  { OVK_BOOL,	OV_SHY,	FALSE, "warn",         NULL,
       0, 0, 0, &PRF.warn,                NULL,
       "Warn about program constructs we cannot handle" },
  { OVK_BOOL,	OV_SHY,	FALSE, "show",         NULL,
       0, 0, 0, &PRF.verbose,             NULL,
       "Show the progress of this processing step" },
  { OVK_BOOL,	OV_SHY,	FALSE, "keep",         NULL,
       0, 0, 0, &PRF.keep,                NULL,
       "Keep intermediate files" },
  { OVK_BOOL,	OV_SHY,	FALSE, "lang_cc",      NULL,
       0, 0, 0, &PRF.language_c,          NULL,
       "The original source was a C program" },
  { OVK_BOOL,	OV_SHY,	FALSE, "lang_f77",     NULL,
       0, 0, 0, &PRF.language_ftn,        NULL,
       "The original source was a Fortran program" },
  { OVK_NAME,	OV_SHY,	FALSE, "trace_calls",  NULL,
       0, 0, 0, &PRF.callemit_filename,   NULL,
       "Instrument to emit a dynamic call-graph (into the given file)" },
  { OVK_NAME,	OV_SHY,	FALSE, "trace_values", NULL,
       0, 0, 0, &PRF.valueemit_filename,  NULL,
       "Instrument to emit a value trace (into the given file)" },
  { OVK_NAME,	OV_SHY,	FALSE, "emit_srcs",    NULL,
       0, 0, 0, &PRF.srcemit_filename,    NULL,
       "Emit temporary sources into the given file" },
  { OVK_NAME,	OV_SHY,	FALSE, "emit_incl",    NULL,
       0, 0, 0, &PRF.inclemit_filename,   NULL,
       "Emit include-file for C into the given file" },
  { OVK_NAME,	OV_SHY,	FALSE, "call_trace",   NULL,
       0, 0, 0, &PRF.calltrace_filename,  NULL,
       "Read call-trace from the given file" },
  { OVK_NAME,	OV_SHY,	FALSE, "orign_src",    NULL,
       0, 0, 0, &PRF.orignsrc_filename,   NULL,
