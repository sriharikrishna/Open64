...
#define WN2F_CONTEXT_tmp_var(c)\
   ((c).flags & WN2F_TMP_VAR)
#define set_WN2F_CONTEXT_tmp_var(c)\
   ((c).flags = (c).flags | WN2F_CONTEXT_TMP_VAR) 
#define reset_WN2F_CONTEXT_tmp_var(c)\
   ((c).flags = (c).flags & ~WN2F_CONTEXT_TMP_VAR)
