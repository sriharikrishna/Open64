...
*** $Author: dsystem $
*** $Source: /m_home/m_utkej/Argonne/cvs2svn/cvs/Open64/osprey1.0/be/lno/ff_utils.h,v $
*** 
*** Description:
*** 
...
#ifdef _KEEP_RCS_ID
static char *ff_utils_rcs_id = "$Source: /m_home/m_utkej/Argonne/cvs2svn/cvs/Open64/osprey1.0/be/lno/ff_utils.h,v $ $Revision: 1.1.1.1 $";
#endif /* _KEEP_RCS_ID */
