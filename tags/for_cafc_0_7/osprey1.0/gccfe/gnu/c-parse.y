...
%type <ttype> affinity_expr layout_specifier upc_blocksizeof upc_localsizeof upc_elemsizeof



	  ...
	  affinity_expr ')'
		{
		  ...
		  emit_line_note ($<filename>11, $<lineno>10);
		  if ($12)
		    expand_affinity_test ($12);
