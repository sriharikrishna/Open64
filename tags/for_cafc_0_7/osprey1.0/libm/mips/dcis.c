 ...
 * $Author: dsystem $
 * $Source: /m_home/m_utkej/Argonne/cvs2svn/cvs/Open64/osprey1.0/libm/mips/dcis.c,v $
 *
 * Revision history:
 *  05-Sep-96 - Original Version
 *
 * Description:	source code for dcis function
 *
 * ====================================================================
 * ====================================================================
 */
...
#ifdef __GNUC__
extern  dcomplex  __libm_dcis(double);
dcomplex    __dcis() __attribute__ ((weak, alias ("__libm_dcis")));
#endif
