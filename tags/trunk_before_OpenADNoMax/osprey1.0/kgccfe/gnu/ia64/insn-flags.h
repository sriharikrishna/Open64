...
#define HAVE_extendsftf2 1
#define HAVE_extenddftf2 1
#define HAVE_truncdfsf2 1
#define HAVE_trunctfsf2 1
#define HAVE_trunctfdf2 1
#define HAVE_floatditf2 1
#define HAVE_fix_truncsfdi2 1
#define HAVE_fix_truncdfdi2 1
#define HAVE_fix_trunctfdi2 1
#define HAVE_fix_trunctfdi2_alts 1
#define HAVE_floatunsdisf2 1
#define HAVE_floatunsdidf2 1
#define HAVE_floatunsditf2 1
#define HAVE_fixuns_truncsfdi2 1
#define HAVE_fixuns_truncdfdi2 1
#define HAVE_fixuns_trunctfdi2 1
#define HAVE_fixuns_trunctfdi2_alts 1
#define HAVE_extv 1
#define HAVE_extzv 1
...
#define HAVE_addtf3 1
#define HAVE_subtf3 1
#define HAVE_multf3 1
#define HAVE_abstf2 1
#define HAVE_negtf2 1
#define HAVE_mintf3 1
#define HAVE_maxtf3 1
...
#if 0  /* since this cause some function undefined in some files at gnu/ 
...
#if 0  /*FMZH*/
static inline rtx gen_floatdidf2                PARAMS ((rtx, rtx));
static inline rtx
gen_floatdidf2(a, b)
...
static inline rtx gen_floatdisf2                PARAMS ((rtx, rtx));
static inline rtx
gen_floatdisf2(a, b)
     rtx a ATTRIBUTE_UNUSED;
     rtx b ATTRIBUTE_UNUSED;
