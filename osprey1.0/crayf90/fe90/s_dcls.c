...
/*         ATD_IM_A_DOPE(attr_idx) = TRUE; */
         ...
         if (ATD_ARRAY_IDX(attr_idx) == NULL_IDX ||
             ...
             BD_ARRAY_CLASS(ATD_ARRAY_IDX(attr_idx)) != Deferred_Shape1 ) {
            AT_DCL_ERR(attr_idx) = TRUE;
...
/* April            create_namelist_descriptor(namelist_grp_attr); */
         }
      }
