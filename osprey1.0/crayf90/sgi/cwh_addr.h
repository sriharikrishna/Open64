...
#ifdef _KEEP_RCS_ID
static char *rcs_id = "$Source: /m_home/m_utkej/Argonne/cvs2svn/cvs/Open64/osprey1.0/crayf90/sgi/cwh_addr.h,v $ $Revision: 1.1.1.1 $";
#endif /* _KEEP_RCS_ID */
...
extern  void cwh_addr_pstore_ST(ST *st,OFFSET_64 off, TY_IDX  ty, WN *rhs);
...
extern  WN * cwh_addr_pstore(WN *wn, OFFSET_64 off, TY_IDX  ty, WN * rhs) ;
...
extern  void cwh_addr_pstore_WN(WN * lhs, OFFSET_64 off, TY_IDX  ty,  WN * rhs) ;
