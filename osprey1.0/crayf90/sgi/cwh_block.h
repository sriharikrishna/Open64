...
#ifdef _KEEP_RCS_ID
static char *rcs_id = "$Source: /m_home/m_utkej/Argonne/cvs2svn/cvs/Open64/osprey1.0/crayf90/sgi/cwh_block.h,v $ $Revision: 1.1.1.1 $";
#endif /* _KEEP_RCS_ID */
...
extern WN * cwh_block_new_and_decl(void) ; // Feb
