...
#ifdef _KEEP_RCS_ID
static char *rcs_id = "$Source: /m_home/m_utkej/Argonne/cvs2svn/cvs/Open64/osprey1.0/crayf90/sgi/cwh_intrin.cxx,v $ $Revision: 1.1.1.1 $";
#endif /* _KEEP_RCS_ID */
...
if (w == NULL)
      return (w); /* give me anything,but don't give me segmentation fault :-) */
...
do_char_intrin_nt(fei_len,INTRN_I4CLEN,1)
