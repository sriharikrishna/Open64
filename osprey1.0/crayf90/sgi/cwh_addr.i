...
OPCODE PStid_Opcode [MTYPE_LAST + 1] = {
  OPCODE_UNKNOWN,    /* MTYPE_UNKNOWN */
  OPCODE_UNKNOWN,    /* MTYPE_UNKNOWN */
  OPC_I1PSTID,     /* MTYPE_I1 */
  OPC_I2PSTID,     /* MTYPE_I2 */
  OPC_I4PSTID,     /* MTYPE_I4 */
  OPC_I8PSTID,     /* MTYPE_I8 */
  OPC_U1PSTID,     /* MTYPE_U1 */
  OPC_U2PSTID,     /* MTYPE_U2 */
  OPC_U4PSTID,     /* MTYPE_U4 */
  OPC_U8PSTID,     /* MTYPE_U8 */
  OPC_F4PSTID,     /* MTYPE_F4 */
  OPC_F8PSTID,     /* MTYPE_F8 */
  OPCODE_UNKNOWN,    /* MTYPE_F10 */
  OPCODE_UNKNOWN,    /* MTYPE_F16 */
  OPCODE_UNKNOWN,    /* MTYPE_STR */
  OPC_FQPSTID,     /* MTYPE_FQ */
  OPC_MPSTID,    /* MTYPE_M */
  OPC_C4PSTID,     /* MTYPE_C4 */
  OPC_C8PSTID,     /* MTYPE_C8 */
  OPC_CQPSTID,     /* MTYPE_CQ */
  OPCODE_UNKNOWN     /* MTYPE_V */
};
...
OPCODE PStore_Opcode [MTYPE_LAST + 1] = {
  OPCODE_UNKNOWN,    /* MTYPE_UNKNOWN */
  OPCODE_UNKNOWN,    /* MTYPE_UNKNOWN */
  OPC_I1PSTORE,    /* MTYPE_I1 */
  OPC_I2PSTORE,    /* MTYPE_I2 */
  OPC_I4PSTORE,    /* MTYPE_I4 */
  OPC_I8PSTORE,    /* MTYPE_I8 */
  OPC_U1PSTORE,    /* MTYPE_U1 */
  OPC_U2PSTORE,    /* MTYPE_U2 */
  OPC_U4PSTORE,    /* MTYPE_U4 */
  OPC_U8PSTORE,    /* MTYPE_U8 */
  OPC_F4PSTORE,    /* MTYPE_F4 */
  OPC_F8PSTORE,    /* MTYPE_F8 */
  OPCODE_UNKNOWN,    /* MTYPE_F10 */
  OPCODE_UNKNOWN,    /* MTYPE_F16 */
  OPCODE_UNKNOWN,    /* MTYPE_STR */
  OPC_FQPSTORE,    /* MTYPE_FQ */
  OPC_MPSTORE,    /* MTYPE_M */
  OPC_C4PSTORE,    /* MTYPE_C4 */
  OPC_C8PSTORE,    /* MTYPE_C8 */
  OPC_CQPSTORE,    /* MTYPE_CQ */
  OPCODE_UNKNOWN     /* MTYPE_V */
};
