...
#ifdef _KEEP_RCS_ID
static char *rcs_id = "$Source: /m_home/m_utkej/Argonne/cvs2svn/cvs/Open64/osprey1.0/crayf90/sgi/cwh_types.cxx,v $ $Revision: 1.21.2.1 $";
#endif /* _KEEP_RCS_ID */
...
extern TY_IDX
cwh_types_mk_module_TY(INT64 size, mUINT16 al )
{
  TY_IDX ty    ;
  INT64 sz  ;
  ...
  sz = bit_to_byte(size);
  ty = cwh_types_mk_struct(sz,al,FLD_HANDLE(),".module.");
