...
// Solaris CC porting
// SIG_DFL is defined in /usr/include/sys/signal.h as extern "C"
// (void(*)())0. Here the compiler will issue a warning because
// old_handler is NOT extern "C".
...
// somehow Solaris WS6 CC expects an "extern C" function as the signal
// handler in the second argument of system call signal().
...
void IPA_LNO_WRITE_FILE::Write_Cleanup()
{
  ...
  ofl->num_of_section = 0;
  ofl->section_list = NULL;
  munmap((char *)ofl->map_addr, (size_t) ofl->mapped_size);
  ofl->map_addr = (char *)NULL;
  ofl->file_size = 0;
} 
