 ...
 *  $Author: dsystem $
 *  $Source: /m_home/m_utkej/Argonne/cvs2svn/cvs/Open64/osprey1.0/be/cg/op_map.cxx,v $
 *
 *  Revision comments:
 *
...
static const char *rcs_id = "$Source: /m_home/m_utkej/Argonne/cvs2svn/cvs/Open64/osprey1.0/be/cg/op_map.cxx,v $ $Revision: 1.1.1.1 $";
#endif /* _KEEP_RCS_ID */
...
struct op_map {
  _OP_MAP_KIND kind;			/* for error checking only */
  HASH_TABLE *tbl;
...
OP_MAP _OP_MAP_Create(_OP_MAP_KIND kind)
/* -----------------------------------------------------------------------
...
BB_OP_MAP BB_OP_MAP_Create_Kind(BB *bb, MEM_POOL *pool, _OP_MAP_KIND kind)
/* -----------------------------------------------------------------------
