...
UINT32 STR_TAB<STR>::insert (const char *str, UINT32 size)
{
  ...
  TYPENAME HASHTABLE::ValueBoolPair insertStatus = hash_table.insert(HASHTABLE::KeyValuePair(StringHashKey(oldLastIndex, size), new_index));
...
void STR_TAB<STR>::init_hash () {
  ...
  while (idx < last_idx) {
    ...
    hash_table.insert(HASHTABLE::KeyValuePair(StringHashKey(idx, length), new_index));
