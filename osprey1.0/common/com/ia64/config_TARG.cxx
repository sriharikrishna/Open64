...
Abi_Name ( TARGET_ABI b)
{
  ...
  switch ( b ) {
    case ABI_I32:	return "i32";
    case ABI_I64:	return "i64";
    default:
      r = bnb[bnb_used].name;
...
Prepare_Target ( void )
{
  ...
  Target_int64 = TRUE;
  Use_32_Bit_Pointers = (Target_ABI == ABI_I32);
#if defined(FRONT_END_C) || defined(FRONT_END_CPLUSPLUS)
  Target_Int_Model = ( Target_ABI == ABI_I64 ) ? TARGET_INT_LP64
				       : TARGET_INT_ILP32;
