...
#include "wutil90.h"
  ...
  INTRN_SILD_NB,                "S_ILD_NB",
  INTRN_SF4LD_NB,               "S_F4LD_NB",
  INTRN_SF8LD_NB,               "LALA",
  INTRN_SMLD_NB,                "S_MLD_NB",

  /* UPC non-blocking strores */
  INTRN_SIST_NB,                "S_IST_NB",
  INTRN_SF4ST_NB,               "S_F4ST_NB",
  INTRN_SF8ST_NB,               "S_F8ST_NB",
  INTRN_SMST_NB,                "S_MST_NB",

  /* UPC put/get syncs */
  INTRN_WAIT_SYNC_MEM,          "SYNC_MEM",
  INTRN_WAIT_SYNC_REG,          "SYNC_REG",
  INTRN_WAIT_SYNC_FLOAT,        "SYNC_FLOAT",
  INTRN_WAIT_SYNC_DOUBLE,       "SYNC_DOUBLE", 
  /* UPC pointer arithmetic */
  INTRN_SPTRADD,                "S_PTRADD",
  INTRN_SPTRDIFF,               "S_PTRDIFF",
  INTRN_SCVTADDR,               "S_CVTADDR",
 
  /* UPC sync */
  INTRN_UPCBAR,                 "UPC_BARRIER",
  INTRN_UPCWAIT,                "UPC_WAIT",
  INTRN_UPCNTFY,                "UPC_NOTIFY",
  INTRN_UPCIAFFT,               "UPC_INT_AFFT",

  INTRN_EXIT,                   "UPC_EXIT",
  INTRN_MYTHREAD,               "MYTHREAD",
  INTRN_THREADS,                "THREADS", 
  INTRN_ALL_ALLOC,               "ALL_ALLOC", 
  INTRN_GLOBAL_ALLOC,            "GLOBAL_ALLOC",  
  INTRN_LOCAL_ALLOC,             "LOCAL_ALLOC",
  INTRN_FREE,                    "UPC_FREE",
  INTRN_THREADOF_S,             "THREADOF_S", 
  INTRN_THREADOF_P,             "THREADOF_P",
  INTRN_PHASEOF_S,              "PHASEOF_S",
  INTRN_PHASEOF_P,              "PHASEOF_P",
  INTRN_ADDROF_S,               "ADDROF_S",
  INTRN_ADDROF_P,               "ADDROF_P",
  INTRN_G_LOCK_ALLOC,            "G_LOCK_ALLOC", 
  INTRN_A_LOCK_ALLOC,            "A_LOCK_ALLOC", 
  INTRN_LOCK_FREE,               "LOCK_FREE",
  INTRN_LOCK,                    "UPC_LOCK", 
  INTRN_LOCK_ATTEMPT,            "LOCK_ATTEMPT", 
  INTRN_LOCK_UNLOCK,             "UPC_UNLOCK",
  INTRN_UPC_MEMCPY,              "UPC_MEMCPY", 
  INTRN_UPC_MEMGET,              "UPC_MEMGET",
  INTRN_UPC_MEMPUT,              "UPC_MEMPUT",
  INTRN_UPC_MEMSET,              "UPC_MEMSET",
  INTRN_S_TO_L, "S_TO_L",
  INTRN_P_TO_L, "P_TO_L",
  INTRN_S_RESET, "S_RESET",
  INTRN_S_RESET_REF, "S_RESET_REF",
  INTRN_ISNULL_S, "ISNULL_S",
  INTRN_ISNULL_P, "ISNULL_P",
  INTRN_ADD_S, "ADD_S",
  INTRN_INC_S, "INC_S",
  INTRN_ADD_P1, "ADD_P1",
  INTRN_INC_P1, "INC_P1",
  ...
  INTRN_GET_S, "GET_S",
  INTRN_GET_P, "GET_P",
  INTRN_PUT_NB_S, "PUT_NB_S",
  INTRN_GET_NB_S, "GET_NB_S",
  INTRN_PUT_NB_P, "PUT_NB_P",
  INTRN_GET_NB_P, "GET_NB_P",
  INTRN_WAIT_SYN, "WAIT_SYN",
  INTRN_TRY_SYN, "TRY_SYN",
  INTRN_PUT_NBI_S, "PUT_NBI_S",
  INTRN_GET_NBI_S, "GET_NBI_S",
  INTRN_PUT_NBI_P, "PUT_NBI_P",
  INTRN_GET_NBI_P, "GET_NBI_P",
  INTRN_WAIT_SYN_GET, "WAIT_SYN_GET",
  INTRN_WAIT_SYN_PUT, "WAIT_SYN_PUT",
  INTRN_WAIT_SYN_ALL, "WAIT_SYN_ALL",
  INTRN_TRY_SYN_GET, "TRY_SYN_GET",
  INTRN_TRY_SYN_PUT, "TRY_SYN_PUT",
  INTRN_TRY_SYN_ALL, "TRY_SYN_ALL",
  INTRN_BEGIN_REGION, "BEGIN_REGION",
  INTRN_END_REGION, "END_REGION",
  INTRN_PUT_S_VAL, "PUT_S_VAL",
  INTRN_PUT_NB_S_VAL, "PUT_NB_S_VAL",
  INTRN_PUT_NBI_S_VAL, "PUT_NBI_S_VAL",
  INTRN_PUT_P_VAL, "PUT_P_VAL",
  INTRN_PUT_NB_P_VAL, "PUT_NB_P_VAL",
  INTRN_PUT_NBI_P_VAL, "PUT_NBI_P_VAL",
  INTRN_GET_S_VAL, "GET_S_VAL",
  INTRN_GET_P_VAL, "GET_P_VAL",
  INTRN_GET_NB_S_VAL,"GET_NB_S_VAL",
  INTRN_GET_NB_P_VAL, "GET_NB_P_VAL",
  INTRN_PUT_S_FVAL, "PUT_S_FVAL", 
  INTRN_PUT_S_DVAL, "PUT_S_DVAL",
  INTRN_GET_S_FVAL, "GET_S_FVAL",
  INTRN_GET_S_DVAL, "GET_S_DVAL",
  INTRN_PUT_P_FVAL, "PUT_P_FVAL",
  INTRN_PUT_P_DVAL, "PUT_P_DVAL",
  INTRN_GET_P_FVAL, "GET_P_FVAL",
  INTRN_GET_P_DVAL, "GET_P_DVAL",
  INTRN_WAIT_SYN_VAL, "WAIT_SYN_VAL",
  INTRN_TLD_ADDR, "TLD_ADDR",
  INTRN_ADD_PI, "ADD_PI",
  INTRN_INC_PI, "INC_PI",
  INTRN_UPCFENCE, "UPCFENCE",
  INTRN_S_TO_P, "S_TO_P",
  INTRN_P_TO_S, "P_TO_S",
  INTRN_SETNULL_S, "SETNULL_S",
  INTRN_SETNULL_P, "SETNULL_P",
