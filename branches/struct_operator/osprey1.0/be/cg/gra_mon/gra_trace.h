...
//  $Author: dsystem $
//  $Source: /m_home/m_utkej/Argonne/cvs2svn/cvs/Open64/osprey1.0/be/cg/gra_mon/gra_trace.h,v $
...
#ifdef _KEEP_RCS_ID
static char *gra_trace_rcs_id = "$Source: /m_home/m_utkej/Argonne/cvs2svn/cvs/Open64/osprey1.0/be/cg/gra_mon/gra_trace.h,v $ $Revision: 1.1.1.1 $";
#endif
#endif
...
void GRA_Trace_Memory(char *string);					   
void GRA_Trace_Memory_Realloc(char *string);
