...
enum gt_types_enum {
 ...
 gt_ggc_e_5CPool, 
 gt_ggc_e_18_ffewhere_root_ll_, 
 gt_ggc_e_13_ffewhere_ll_, 
 gt_ggc_e_15_ffewhere_file_, 
 gt_ggc_e_16tree_ggc_tracker, 
 gt_ggc_e_15f_binding_level, 
...
extern void gt_ggc_mx_imp_entry PARAMS ((void *));
#define gt_ggc_m_16hashed_attribute(X) do { \
  if (X != NULL) gt_ggc_mx_hashed_attribute (X);\
  } while (0)
extern void gt_ggc_mx_hashed_attribute PARAMS ((void *));
#define gt_ggc_m_12hashed_entry(X) do { \
  if (X != NULL) gt_ggc_mx_hashed_entry (X);\
  } while (0)
extern void gt_ggc_mx_hashed_entry PARAMS ((void *));
#define gt_ggc_m_3JCF(X) do { \
  if (X != NULL) gt_ggc_mx_JCF (X);\
  } while (0)
extern void gt_ggc_mx_JCF PARAMS ((void *));
#define gt_ggc_m_18treetreehash_entry(X) do { \
  if (X != NULL) gt_ggc_mx_treetreehash_entry (X);\
  } while (0)
extern void gt_ggc_mx_treetreehash_entry PARAMS ((void *));
#define gt_ggc_m_5CPool(X) do { \
  if (X != NULL) gt_ggc_mx_CPool (X);\
  } while (0)
extern void gt_ggc_mx_CPool PARAMS ((void *));
#define gt_ggc_m_18_ffewhere_root_ll_(X) do { \
  if (X != NULL) gt_ggc_mx__ffewhere_root_ll_ (X);\
  } while (0)
extern void gt_ggc_mx__ffewhere_root_ll_ PARAMS ((void *));
#define gt_ggc_m_13_ffewhere_ll_(X) do { \
  if (X != NULL) gt_ggc_mx__ffewhere_ll_ (X);\
  } while (0)
extern void gt_ggc_mx__ffewhere_ll_ PARAMS ((void *));
#define gt_ggc_m_15_ffewhere_file_(X) do { \
  if (X != NULL) gt_ggc_mx__ffewhere_file_ (X);\
  } while (0)
extern void gt_ggc_mx__ffewhere_file_ PARAMS ((void *));
#define gt_ggc_m_16tree_ggc_tracker(X) do { \
  if (X != NULL) gt_ggc_mx_tree_ggc_tracker (X);\
  } while (0)
extern void gt_ggc_mx_tree_ggc_tracker PARAMS ((void *));
#define gt_ggc_m_15f_binding_level(X) do { \
  if (X != NULL) gt_ggc_mx_f_binding_level (X);\
  } while (0)
extern void gt_ggc_mx_f_binding_level PARAMS ((void *));
#define gt_ggc_m_11align_stack(X) do { \
  if (X != NULL) gt_ggc_mx_align_stack (X);\
  } while (0)
extern void gt_ggc_mx_align_stack PARAMS ((void *));
#define gt_ggc_m_4feed(X) do { \
  if (X != NULL) gt_ggc_mx_feed (X);\
  } while (0)
extern void gt_ggc_mx_feed PARAMS ((void *));
#define gt_ggc_m_11token_chunk(X) do { \
  if (X != NULL) gt_ggc_mx_token_chunk (X);\
  } while (0)
extern void gt_ggc_mx_token_chunk PARAMS ((void *));
#define gt_ggc_m_13unparsed_text(X) do { \
  if (X != NULL) gt_ggc_mx_unparsed_text (X);\
  } while (0)
extern void gt_ggc_mx_unparsed_text PARAMS ((void *));
#define gt_ggc_m_16named_label_list(X) do { \
  if (X != NULL) gt_ggc_mx_named_label_list (X);\
  } while (0)
extern void gt_ggc_mx_named_label_list PARAMS ((void *));
#define gt_ggc_m_20named_label_use_list(X) do { \
  if (X != NULL) gt_ggc_mx_named_label_use_list (X);\
  } while (0)
extern void gt_ggc_mx_named_label_use_list PARAMS ((void *));
#define gt_ggc_m_11saved_scope(X) do { \
  if (X != NULL) gt_ggc_mx_saved_scope (X);\
  } while (0)
extern void gt_ggc_mx_saved_scope PARAMS ((void *));
#define gt_ggc_m_11z_candidate(X) do { \
  if (X != NULL) gt_ggc_mx_z_candidate (X);\
  } while (0)
extern void gt_ggc_mx_z_candidate PARAMS ((void *));
#define gt_ggc_m_8lang_id2(X) do { \
  if (X != NULL) gt_ggc_mx_lang_id2 (X);\
  } while (0)
extern void gt_ggc_mx_lang_id2 PARAMS ((void *));
#define gt_ggc_m_15binding_entry_s(X) do { \
  if (X != NULL) gt_ggc_mx_binding_entry_s (X);\
  } while (0)
extern void gt_ggc_mx_binding_entry_s PARAMS ((void *));
#define gt_ggc_m_15binding_table_s(X) do { \
  if (X != NULL) gt_ggc_mx_binding_table_s (X);\
  } while (0)
extern void gt_ggc_mx_binding_table_s PARAMS ((void *));
#define gt_ggc_m_16cp_binding_level(X) do { \
  if (X != NULL) gt_ggc_mx_cp_binding_level (X);\
  } while (0)
extern void gt_ggc_mx_cp_binding_level PARAMS ((void *));
#define gt_ggc_m_11cxx_binding(X) do { \
  if (X != NULL) gt_ggc_mx_cxx_binding (X);\
  } while (0)
extern void gt_ggc_mx_cxx_binding PARAMS ((void *));
#define gt_ggc_m_17cxx_saved_binding(X) do { \
  if (X != NULL) gt_ggc_mx_cxx_saved_binding (X);\
  } while (0)
extern void gt_ggc_mx_cxx_saved_binding PARAMS ((void *));
...
extern void gt_ggc_m_P18treetreehash_entry4htab PARAMS ((void *));
