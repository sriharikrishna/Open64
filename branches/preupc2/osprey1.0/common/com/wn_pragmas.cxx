...
WN_PRAGMA_DESC WN_pragmas[] = {
  ...
  { PUSER_MP, WN_PRAGMA_SCOPE_ON,       "PARALLEL_WORKSHARE" },
  { PUSER_MP, WN_PRAGMA_SCOPE_ON,	"WORKSHARE" },
  { PUSER_MP, WN_PRAGMA_SCOPE_SPECIAL,	"COPYPRIVATE" },
  { PUSER_MP, WN_PRAGMA_SCOPE_POINT,	"FLUSH" },
  ...
  { (WN_PRAGMA_USERS) (PUSER_IPA|PUSER_WOPT|PUSER_LNO|PUSER_CG|PUSER_W2C|PUSER_REGION), WN_PRAGMA_SCOPE_ON, 	"STRICT_START" },
  { (WN_PRAGMA_USERS)(PUSER_IPA|PUSER_WOPT|PUSER_LNO|PUSER_CG|PUSER_W2C|PUSER_REGION) , WN_PRAGMA_SCOPE_OFF, 	"STRICT_END" },
  { (WN_PRAGMA_USERS) (PUSER_IPA|PUSER_WOPT|PUSER_LNO|PUSER_CG|PUSER_W2C|PUSER_REGION), WN_PRAGMA_SCOPE_ON, 	"RELAXED_START" },
  { (WN_PRAGMA_USERS)(PUSER_IPA|PUSER_WOPT|PUSER_LNO|PUSER_CG|PUSER_W2C|PUSER_REGION) , WN_PRAGMA_SCOPE_OFF, 	"RELAXED_END" },
  { (WN_PRAGMA_USERS)(PUSER_IPA|PUSER_WOPT|PUSER_LNO|PUSER_CG|PUSER_W2C|PUSER_REGION) , WN_PRAGMA_SCOPE_POINT, 	"FORALL_LOOP" },
  { (WN_PRAGMA_USERS)(PUSER_IPA|PUSER_WOPT|PUSER_LNO|PUSER_CG|PUSER_W2C|PUSER_REGION) , WN_PRAGMA_SCOPE_POINT, 	"FORALL_AFFINITY_TEST" },
