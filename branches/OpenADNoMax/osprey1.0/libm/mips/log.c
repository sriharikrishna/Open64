 ...
 * $Author: dsystem $
 * $Source: /m_home/m_utkej/Argonne/cvs2svn/cvs/Open64/osprey1.0/libm/mips/log.c,v $
 *
 * Revision history:
 *  09-Jun-93 - Original Version
 *
 * Description:	source code for log function
 *
 * ====================================================================
 * ====================================================================
 */

static char *rcs_id = "$Source: /m_home/m_utkej/Argonne/cvs2svn/cvs/Open64/osprey1.0/libm/mips/log.c,v $ $Revision: 1.1.1.1 $";
...
double    log() __attribute__ ((weak, alias ("__log")));
 ...
 * FunctionName		log
 *
 * Description		computes logarithm of arg
 *
 * ====================================================================
 */
...
zeroarg:
		...
		if ( matherr( &exstruct ) == 0 )
		{
			fprintf(stderr, "overflow range error in log\n");
			SETERRNO(ERANGE);
		}
...
long double    logl() __attribute__ ((weak, alias ("__logl")));
...
{	
	return ( (long double)__log((double)x) );
}
