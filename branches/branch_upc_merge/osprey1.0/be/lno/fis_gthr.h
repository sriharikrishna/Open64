...
#ifdef _KEEP_RCS_ID
static char *phase1_rcs_id = "$Source: /m_home/m_utkej/Argonne/cvs2svn/cvs/Open64/osprey1.0/be/lno/fis_gthr.h,v $ $Revision: 1.1.1.1 $";
#endif /* _KEEP_RCS_ID */
#endif

#ifndef _phase25_INCLUDED
#define _phase25_INCLUDED
